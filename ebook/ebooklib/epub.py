...
class EpubItem(object):
    ...
    def get_type(self):
        ...
        We map type according to the extensions which are defined in ebook.EXTENSIONS.
...
class EpubHtml(EpubItem):
    ...
    def get_type(self):
        """
        Always returns ebook.ITEM_DOCUMENT as type of this document.

        :Returns:
          Always returns ebook.ITEM_DOCUMENT
        """
